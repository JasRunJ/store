...
function title() {
	  console.log(chalk.bold.blue(figlet.textSync('YAMI BOT', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n${chalk.red('[ YAMI - BOT ]')}\n\n${chalk.italic.magenta('• Author')} : ${chalk.white('Yami-Store')}\n${chalk.italic.magenta('• Wa')} : ${chalk.white('081220670449')}\n${chalk.italic.magenta('• Caption')} : ${chalk.white('Rela Bergadang Demi Mencari Cuan:v')}\n`))
}
/**
